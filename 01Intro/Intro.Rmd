...
```{r snow,eval=TRUE}
  knitr::include_graphics('Snow-cholera-map.jpg',dpi = 40)
```
...
```{r snowres,eval=TRUE}
  knitr::include_graphics('Snow_Cholera.svg')
```
...
knitr::include_graphics('florose.jpg',dpi=40)
```
...
knitr::include_graphics('nightingale_rose_chart.svg')
```
...
```{r minard}
knitr::include_graphics('Minard_Map.svg')
```

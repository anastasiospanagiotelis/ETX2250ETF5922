...
<video width="720" height="480" controls>
  <source src="Rosling.webm" type="video/webm">
</video>
---
...
```{r}
knitr::include_graphics('jet.jpeg')
```

A better palette (by the above criteria) is viridis

```{r}
knitr::include_graphics('ViridisContinuousContinuous.png')
```
...
```{r}
knitr::include_graphics('mona-lisa-rainbow.png',dpi = 100)
```
...
```{r}
knitr::include_graphics('mona-lisa-gradient.png',dpi = 100)
```

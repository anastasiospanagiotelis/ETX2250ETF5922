...
##Introduction to R
  ...
  2. Install the `tidyverse` onto your coputer.
...
`r if(sols) "There are two outliers in the data.  Further inspection shows that there are Germany and the USA.  In the case of Germany, it was by far Switzerlands largest export market in 1988 and is still the second market.  The US was the largest export market in December 2018 but was only the fourth largest in January 1988."`
